  ...
  return shell(
    <>
      ...
      <Card title="إجراءات غير متاحة بعد">
        <ul>
          <li><strong>إعادة معالجة حدث (ADM-05.A05):</strong> تحتاج الاحتفاظ بحمولة الحدث وإعادة تمريرها عبر فحص التوقيع نفسه، وهي ضمن أدوات التشغيل في PART-13. الأحداث التي لم تُطبَّق معزولة ومعدودة أعلاه بالفعل.</li>
          <li><strong>تصدير الكشوف وتنزيلها:</strong> مستندات مولَّدة تحتاج مخزن الوثائق (PART-13).</li>
        </ul>
      </Card>
    </>
  );
