...
try {
  ...
  rows.push('## فريق المنصة', '',
    'تسجيل الدخول بالبريد وكلمة المرور فقط، دون رمز. تبقى بعض العمليات الحساسة (قرار توثيق، تغيير حساب بنكي) تطلب رمزًا: اكتب `pnpm demo:code` في الطرفية للحصول عليه.',
    `مفتاح تطبيق المصادقة (اختياري): \`${staffKey}\``, '',
  ...
  const file = [
    ...
    '',
    'سجّل الدخول من http://127.0.0.1:3000/ar/login بالبريد وكلمة المرور. كل الحسابات تدخل مباشرة دون رمز على هذه النسخة المحلية.',
