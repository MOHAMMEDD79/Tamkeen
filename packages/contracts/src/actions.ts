...
export const ACTION_MANIFEST: readonly ActionEntry[] = [
  ...
  { id: 'AUTH-03.A01', page: 'AUTH-03', route: '/recover', method: 'POST', endpoint: '/auth/request-password-reset', permission: 'public', status: 'implemented', part: 'PART-02', testRef: 'tests/auth.integration.test.ts' },
  { id: 'AUTH-03.A02', page: 'AUTH-03', route: '/verify', method: 'POST', endpoint: '/auth/send-verification-email', permission: 'public', status: 'implemented', part: 'PART-02', testRef: 'tests/auth.integration.test.ts' },
  { id: 'AUTH-03.A03', page: 'AUTH-03', route: '/verify', method: 'GET', endpoint: '/auth/verify-email', permission: 'token owner', status: 'implemented', part: 'PART-02', testRef: 'tests/auth.integration.test.ts' },
  { id: 'AUTH-03.A04', page: 'AUTH-03', route: '/reset', method: 'POST', endpoint: '/auth/reset-password', permission: 'token owner', status: 'implemented', part: 'PART-02', testRef: 'tests/auth.integration.test.ts' },
